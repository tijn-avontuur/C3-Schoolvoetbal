<x-guest-layout>
    ...
    <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6 mt-16 border border-green-500">
        ...
        <p class="text-sm text-gray-500 text-center mb-6">{{ __('Join us today! Fill in your details to get started.') }}</p>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-text-input id="name" class="block mt-1 w-full border-green-300 focus:ring-green-500 focus:border-green-500"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password_confirmation" class="block mt-1 w-full border-green-300 focus:ring-green-500 focus:border-green-500"
