            ...
            <div>
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <form method="POST" action="{{ route('teams.store') }}">
                        ...
                        <input type="submit" value="Team Aanmaken" class="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 rounded-lg shadow-md transition duration-300">
                    </form>
                </div>
            </div>
        </div>
